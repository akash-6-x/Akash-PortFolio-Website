    ...
    <>
        {isDesktop && <>
            ...
            <section className={`z-10 w-[100%] h-[11%] flex justify-center items-center gap-14`}>
                ...
                <button type="button" className={`${UpdateIconFoucsed && 'shadow-[0_0_10px_6px_blue]'} cursor-pointer hover:scale-110 ease-in-out duration-400 will-change-transform bg-blue-400 flex shrink-0 justify-center items-center border-2 w-[190px] h-[55px] rounded-[16px] ${DarkMode?'text-white border-white':'text-black border-black'}`} onFocus={()=>{setUpdateIconFocused(true)}} onBlur={()=>{setUpdateIconFocused(false)}} onClick={UpdatePage}>
                    <div className={`w-[80%] h-[70%] flex`}>
                        <div className="w-[30%] h-full flex justify-center items-center text-[18px]"><ArrowUp /></div>
                        <div className="w-[70%] h-full flex justify-center items-center text-[21px] font-bold quicksand-shit">Update</div>
                    </div>
                </button>

                <button type="button" className={`${DeleteIconFoucsed && 'shadow-[0_0_10px_6px_blue]'} cursor-pointer hover:scale-110 ease-in-out duration-400 will-change-transform bg-red-400 flex shrink-0 justify-center items-center border-2 w-[190px] h-[55px] rounded-[16px] ${DarkMode?'text-white border-white':'text-black border-black'}`} onFocus={()=>{setDeleteIconFocused(true)}} onBlur={()=>{setDeleteIconFocused(false)}} onClick={DeletePage}>
                    <div className={`w-[80%] h-[70%] flex`}>
                        <div className="w-[30%] h-full flex justify-center items-center text-[18px]"><Trash /></div>
                        <div className="w-[70%] h-full flex justify-center items-center text-[21px] font-bold quicksand-shit">Delete</div>
                    </div>
                </button>
        ...
        {(isLaptop || isTab) && <>
            ...
            <section className={`w-[100%] h-[12%] flex justify-center items-center gap-10`}>
                ...
                <button type="button" className={`${UpdateIconFoucsed && 'shadow-[0_0_10px_6px_blue]'} cursor-pointer hover:scale-110 ease-in-out duration-400 will-change-transform bg-blue-400 flex justify-center items-center border-2 w-[160px] h-[50px] rounded-[16px] ${DarkMode?'text-white border-white':'text-black border-black'}`} onFocus={()=>{setUpdateIconFocused(true)}} onBlur={()=>{setUpdateIconFocused(false)}} onClick={UpdatePage}>
                    <div className={`w-[80%] h-[70%] flex`}>
                        <div className="w-[30%] h-full flex justify-center items-center text-[18px]"><ArrowUp /></div>
                        <div className="w-[70%] h-full flex justify-center items-center text-[21px] font-bold quicksand-shit">Update</div>
                    </div>
                ...
                <button type="button" className={`${DeleteIconFoucsed && 'shadow-[0_0_10px_6px_blue]'} cursor-pointer hover:scale-110 ease-in-out duration-400 will-change-transform bg-red-400 flex justify-center items-center border-2 w-[160px] h-[50px] rounded-[16px] ${DarkMode?'text-white border-white':'text-black border-black'}`} onFocus={()=>{setDeleteIconFocused(true)}} onBlur={()=>{setDeleteIconFocused(false)}} onClick={DeletePage}>
                    <div className={`w-[80%] h-[70%] flex`}>
                        <div className="w-[30%] h-full flex justify-center items-center text-[18px]"><Trash /></div>
                        <div className="w-[70%] h-full flex justify-center items-center text-[21px] font-bold quicksand-shit">Delete</div>
                    </div>
